...
- Verificato via simulate (4 turni, LLM reale): aperture diverse ("Sì, guarda…","Guarda, spesso…","Ti dico subito…"), prezzo con scadenza dinamica, "secondo me", nessun cuore, handoff "Va bene, allora controllo le disponibilità e ti richiamo" → attesa_chiamata.
